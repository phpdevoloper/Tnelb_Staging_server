        ...
        <form id="competency_form_a" enctype="multipart/form-data">
            ...
            <div class="tabs" id="tabbedForm">
                ...
                <div class="tab tab-btn" data-name="Basic Details">
                    ...
                    <div class="row {{ in_array('basic_details', $returnsection ?? []) ? '' : 'd-none' }}" id="basic_details">
                    ...
                    <div class="{{ in_array('ownership_details', $returnsection ?? []) ? '' : 'd-none' }}" id="ownership_details">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 {{ in_array('authorized_sign', $returnsection ?? []) ? '' : 'd-none' }}" id="authorized_sign">
                        ...
                        <div class="col-md-6 {{ in_array('previous_licence', $returnsection ?? []) ? '' : 'd-none' }}" id="previous_licence">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-12">
                ...
                <div class="tab" data-name="Staff & Bank Details">
                    ...
                    <div class="row {{ in_array('staff_details', $returnsection ?? []) ? '' : 'd-none' }}" id="staff_details">
                    ...
                    <div class="row ">
                        <div class="col-md-12  ">
                            <div class="row align-items-center head_label {{ in_array('bank_solvency', $returnsection ?? []) ? '' : 'd-none' }}" id="bank_solvency">
                                <div class="col-12 col-md-12 title_bar">
                            ...
                            <div class="row {{ in_array('bank_solvency', $returnsection ?? []) ? '' : 'd-none' }}" id="bank_solvency">
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-12 col-md-12">
                            ...
                            <hr class="">
                            <div class="{{ in_array('atachment_points', $returnsection ?? []) ? '' : 'd-none' }}" id="atachment_points">
                            ...
                            <div class="row align-items-center head_label {{ in_array('address_proof', $returnsection ?? []) ? '' : 'd-none' }}" id="address_proof">
                            ...
                            <div class="row mt-2 {{ in_array('address_proof', $returnsection ?? []) ? '' : 'd-none' }}" id="address_proof">
                                <div class="col-12 col-md-3">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-5 ">
                ...
                <div class="tab {{ in_array('equipments_details', $returnsection ?? []) ? '' : 'd-none' }}" id="equipments_details" data-name="Equipment / Instruments List ">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 title_bar">
